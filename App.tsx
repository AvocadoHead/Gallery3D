    ...
    <div className="w-full h-screen relative bg-gradient-to-br from-[#f8fafc] to-[#e2e8f0] overflow-hidden">
      ...
      `}>
        ...
        >
          ...
          <p className="text-[11px] text-slate-500 mt-1 ml-1">Craft your own sphere</p>
        </button>

        {builderOpen && (
          <div className="w-[360px] bg-white/80 backdrop-blur-lg border border-white/70 rounded-3xl shadow-xl p-4 space-y-4">
            ...
            <div className="bg-slate-900 text-white rounded-2xl p-3 flex items-center gap-3 shadow-inner">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-amber-400 to-pink-500 flex items-center justify-center text-slate-900 font-bold">1$</div>
              <div className="text-sm leading-tight">
                <p className="font-semibold">Enjoying the gallery?</p>
